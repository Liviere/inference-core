...
class TestEmailService:
    ...
    def setup_method(self):
        ...
        self.full_config = FullEmailConfig(
            email=self.email_config, settings=self.settings
        )
    ...
    def test_send_simple_email(self, mock_smtp_ssl):
        ...
        message_id = service.send_email(
            to="recipient@example.com", subject="Test Subject", text="Test message body"
        )
    ...
    def test_send_email_with_starttls(self, mock_smtp):
        ...
        service.send_email(
            to="recipient@example.com", subject="Test STARTTLS", text="Test message"
        )
    ...
    def test_missing_password_error(self):
        ...
        with pytest.raises(EmailSendError, match="Failed to send email"):
            service.send_email(
                to="recipient@example.com", subject="Test", text="Test message"
            )
    ...
    def test_send_email_with_custom_headers(self, mock_smtp_ssl):
        ...
        custom_headers = {"X-Custom-Header": "test-value", "X-Priority": "high"}
...
class TestEmailServiceUtilities:
    ...
    def test_get_email_service_with_config(self):
        ...
        with patch(
            "inference_core.services.email_service.is_email_configured",
            return_value=True,
        ):
            with patch(
                "inference_core.services.email_service.get_email_config"
            ) as mock_get_config:
                mock_config = Mock()
    ...
    def test_get_email_service_init_error(self):
        ...
        with patch(
            ...
            with patch(
                "inference_core.services.email_service.EmailService"
            ) as mock_service:
