"""
Unit tests for inference_core.services.task_service module
...
class TestTaskService:
    ...
    def test_get_task_status(self, mock_celery_app, mock_async_result_class):
        ...
        mock_async_result_class.assert_called_once_with(
            "test-task-id", app=mock_celery_app
        )
    ...
    @patch("inference_core.services.task_service.AsyncResult")
    @patch("inference_core.services.task_service.celery_app")
    def test_get_task_result_with_timeout(
...
class TestGetTaskService:
    ...
    @patch("inference_core.services.task_service.task_service")
...
class TestTaskServiceErrorHandling:
    ...
    @patch("inference_core.services.task_service.AsyncResult")
    @patch("inference_core.services.task_service.celery_app")
    def test_get_task_result_timeout_error(
        self, mock_celery_app, mock_async_result_class
    ):
    ...
    @patch("inference_core.services.task_service.AsyncResult")
    @patch("inference_core.services.task_service.celery_app")
    def test_get_task_result_task_failure(
        self, mock_celery_app, mock_async_result_class
    ):
