...
class FakeTaskService:
    ...
    async def get_worker_stats_async(self, timeout=None, cache_ttl=0.0):
        self.calls.append({"timeout": timeout, "cache_ttl": cache_ttl})
...
async def test_health_overall(monkeypatch):
    ...
    async with AsyncClient(
        ...
        assert FakeTaskService.calls == [{"timeout": 1.0, "cache_ttl": 5.0}]
