...
class TestGeminiProviderIntegration:
    ...
    def test_batch_failure_scenario(self):
        ...
        prepared = self.provider.prepare_payloads(
            batch_items, "gemini-2.0-flash", "chat"
        )
    ...
    def test_transient_error_handling(self):
        ...
        self.mock_client.batches.create.side_effect = Exception(
...
class TestClaudeProviderIntegration:
    ...
    def test_complete_batch_workflow_success(self):
        ...
        batch_items = [
            ...
            {
                "id": "item_2",
                "input_payload": {"content": "How are you today?", "temperature": 0.7},
            },
        ]
        ...
        self.mock_client.messages.batches.retrieve = Mock(
            return_value=mock_batch_completed
        )
        ...
        with patch.object(self.provider, "poll_status") as mock_poll:
            ...
            self.mock_client.messages.batches.results.return_value = [
                mock_entry1,
                mock_entry2,
            ]
    ...
    def test_transient_error_handling(self):
        ...
        # Mock rate limit error
        self.mock_client.messages.batches.create.side_effect = Exception(
            "Rate limit exceeded"
        )
