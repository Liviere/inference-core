...
class MCPToolManager:
    ...
    async def get_tools(
        self, profile_name: Optional[str] = None, user: Optional[Dict[str, Any]] = None
    ) -> List[Any]:
    ...
    async def _initialize_client(self):
        ...
        try:
            ...
            logger.info(
                f"Initializing MCP client with servers: {list(server_configs.keys())}"
            )
    ...
    def get_profile_limits(self, profile_name: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "tool_retry_attempts": getattr(profile, "tool_retry_attempts", 2),
