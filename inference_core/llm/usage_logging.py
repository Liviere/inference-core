...
class UsageNormalizer:
    ...
    @staticmethod
    def normalize_usage(raw_usage: Dict[str, Any], key_aliases: Dict[str, str]) -> Dict[str, Any]:
        """
...
class PricingCalculator:
    ...
    def compute_cost(
        ...
        known_dimensions = {"input_tokens", "output_tokens"} | set(pricing_config.extras.keys())
    ...
    @staticmethod
    def _calculate_dimension_cost(tokens: int, cost_per_1k: float, multiplier: float = 1.0) -> float:
    ...
    def _round_costs(cost_result: Dict[str, Any], decimals: int) -> Dict[str, Any]:
        ...
        cost_fields = ["cost_input_usd", "cost_output_usd", "cost_extras_usd", "cost_total_usd"]
        ...
        try:
            ...
            if self.pricing_config:
                ...
                pricing_snapshot = {
                    ...
                    "context_tiers": [
                        {"max_context": t.max_context, "multiplier": t.multiplier}
                        for t in self.pricing_config.context_tiers
                    ],
                }
            ...
            log_entry = LLMRequestLog(
                ...
                extra_costs=cost_result.get("extra_costs") if cost_result.get("extra_costs") else None,
            ...
            async with get_async_session() as session:
                ...
                logger.debug(f"Persisted usage log for {self.task_type} request: {log_entry.id}")
