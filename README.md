...
- `EMBEDDING_BACKEND=remote`: the API uses LangChain embedding providers configured in `llm_config.yaml` under `embeddings:` (OpenAI, Gemini, DeepInfra, Fireworks, Ollama).
